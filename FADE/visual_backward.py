...
import numpy as np
from main_backward import PINN
import os
...
model = PINN()
model.net.load_state_dict(torch.load(f'modelb2.param'))
print(model.lambda_m)
print(model.lambda_x)
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
file_path = 'data3_real.csv'
...
ax_curve1.text(6.8, y_value_to_mark, f't={t_max * 0.2:.1f}s', color='black', fontsize=11, ha='center', va='center')
ax_curve1.text(10.86, y_value_to_mark, f't={t_max * 0.4:.1f}s', color='black', fontsize=11, ha='center', va='center')
ax_curve1.text(15.0, y_value_to_mark, f't={t_max * 0.6:.1f}s', color='black', fontsize=11, ha='center', va='center')
ax_curve1.text(18.58, 0.3, f't={t_max * 0.8:.1f}s', color='black', fontsize=11, ha='center', va='center')
ax_curve1.text(19.42, 0.38, f't={t_max * 1.0:.1f}s', color='black', fontsize=11, ha='center', va='center')
