...
ax_curve1.text(6.7, y_value_to_mark, f't={t_max * 0.2:.1f}s', color='black', fontsize=11, ha='center', va='center')
ax_curve1.text(9.3, y_value_to_mark, f't={t_max * 0.4:.1f}s', color='black', fontsize=11, ha='center', va='center')
ax_curve1.text(11.5, y_value_to_mark, f't={t_max * 0.6:.1f}s', color='black', fontsize=11, ha='center', va='center')
ax_curve1.text(13.8, 0.25, f't={t_max * 0.8:.1f}s', color='black', fontsize=11, ha='center', va='center')
ax_curve1.text(17.0, 0.25, f't={t_max * 1.0:.1f}s', color='black', fontsize=11, ha='center', va='center')
...
ax_curve2.text(3.42, 0.63, f'Section_{x_max * 0.4:.1f}m', color='black', fontsize=11, ha='center', va='center')
ax_curve2.text(7.7, 0.64 ,f'Section_{x_max * 0.6:.1f}m', color='black', fontsize=11, ha='center', va='center')
ax_curve2.text(9.0, 0.25, f'Section_{x_max * 0.8:.1f}m', color='black', fontsize=11, ha='center', va='center')
ax_curve2.text(9.4, 0.05, f'Section_{x_max * 1.0:.1f}m', color='black', fontsize=11, ha='center', va='center')
